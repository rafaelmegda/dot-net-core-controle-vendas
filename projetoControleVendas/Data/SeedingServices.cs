...
namespace projetoControleVendas.Data
{
    ...
    {
        private projetoControleVendasContext _context;

        public SeedingServices(projetoControleVendasContext context)
        {
            _context = context;
        }
        ...
        public void popularBaseDados()
        {
            ...
            //Populando o banco usando o Entity
